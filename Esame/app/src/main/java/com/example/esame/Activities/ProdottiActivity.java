    ...
    public void selectProduct(View view) {
        ...
        switch (view.getId()) {
            case R.id.pane:
                ...
                finish();
                Toast.makeText(this, "Pane aggiunto!", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.latte:
                ...
                setResult(RESULT_OK, intent);
                finish();
                Toast.makeText(this, "Latte aggiunto!", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.olio:
                ...
                setResult(RESULT_OK, intent);
                finish();
                Toast.makeText(this, "Olio aggiunto!", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.uova:
                ...
                setResult(RESULT_OK, intent);
                finish();
                Toast.makeText(this, "Uova aggiunte!", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.formaggio:
                ...
                setResult(RESULT_OK, intent);
                finish();
                Toast.makeText(this, "Formaggio aggiunto!", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.riso:
                ...
                setResult(RESULT_OK, intent);
                finish();
                Toast.makeText(this, "Riso aggiunto!", Toast.LENGTH_SHORT).show();
                break;
